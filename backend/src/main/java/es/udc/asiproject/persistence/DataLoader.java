...
public class DataLoader implements ApplicationRunner {
	...
	if (userDao.count() == 0) {
	    ...
	    userDao.save(User.builder().email("cliente1@gmail.com").password(passwordEncoder.encode("pass"))
		    .firstName("Roberto").lastName("Carlos").role(RoleType.USER).build());
	    userDao.save(User.builder().email("cliente2@gmail.com").password(passwordEncoder.encode("pass"))
		    .firstName("Pepe").lastName("Lopez").role(RoleType.USER).build());
	}
