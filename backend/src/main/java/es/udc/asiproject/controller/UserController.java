...
public class UserController {
	...
	@GetMapping("/clients")
	@ResponseStatus(HttpStatus.OK)
	public PageDto<ClientDto> findClients(@RequestAttribute Long userId, @RequestParam(defaultValue = "") String keywords,
			@RequestParam(defaultValue = "0") int pageNumber, @RequestParam(defaultValue = "10") int pageSize) throws InstanceNotFoundException {

		return PageMapper.convertToDto(
				userService.findClients(userId, keywords, pageNumber, pageSize),
