...
export const findPacks = page => dispatch => {
	backend.packService.findPacks(page,
		result => dispatch(findPacksCompleted({page, result}))
	);
}

export const previousFindPacksPage = page =>
	findPacks(page-1);

export const nextFindPacksPage = page =>
	findPacks(page+1);
