...
const Accommodations = () => {
  ...
  const [accommodation, setAccommodations] = React.useState(null);
  ...
  useEffect(() => {
    dispatch(
      actions.getAccommodationsManager(
        (result) => {
    ...
    <React.Fragment>
      <Box sx={{ textAlign: "center" }}>
        <Typography variant="h6">
          <FormattedMessage id="project.products.accommodations" />
        </Typography>
      </Box>
